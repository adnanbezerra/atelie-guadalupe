...
export function HomePageClient() {
  const { data, isLoading, error } = useProductCatalog({ page: 1, pageSize: 6 });
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.2fr_0.8fr]">
          <Card className="overflow-hidden border-none bg-[linear-gradient(135deg,rgba(255,249,240,0.88),rgba(255,255,255,0.72))] p-8 sm:p-12">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-[var(--color-muted)]">
              O novo frontend traduz as telas do Stitch para uma experiência
              contemplativa, com catálogo botânico, artes sacras e integração com
              a API do ateliê.
            </p>
            ...
            <div className="mt-12 grid gap-4 sm:grid-cols-3">
              <Card className="bg-white/75 p-5">
                ...
                <p className="mt-2 font-display text-3xl font-semibold">100%</p>
                  ...
                  <div className="relative flex min-h-[280px] items-end p-6 text-white">
                    <div>
                      <p className="text-xs uppercase tracking-[0.25em] text-white/70">
                        {index === 0 ? "Beleza Natural" : "Artesanato"}
                      </p>
                      <p className="mt-2 font-display text-3xl font-semibold">
                        {index === 0
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-7 text-[var(--color-muted)]">
                Esta seção depende do backend. Durante o carregamento, exibimos
                skeletons para manter a página fluida.
              </p>
            </div>
            <Link href="/beleza-natural">
