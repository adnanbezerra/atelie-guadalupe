                ...
                <Card className="overflow-hidden p-0">
                    <div className="bg-[linear-gradient(145deg,rgba(153,102,51,0.95),rgba(88,57,24,0.95))] p-8 text-white">
                        ...
                        <p className="mt-3 text-sm leading-7 text-white/75">
                            Onde o backend ainda não expõe customização nativa,
                            a interface já antecipa a experiência e deixa a
                ...
                <div>
                    <div className="mb-5 flex flex-wrap items-center justify-between gap-4">
                        <p className="text-sm text-[var(--color-muted)]">
                            Mostrando {filteredProducts.length} itens desta
                            coleção
                        </p>
