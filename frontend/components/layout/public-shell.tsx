        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden min-w-72 flex-1 justify-end md:flex">
            <div className="relative w-full max-w-sm">
              <Input className="pl-11" placeholder="Buscar no ateliê..." />
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 lg:grid-cols-4 lg:px-8">
          <div className="lg:col-span-2">
            ...
            <p className="mt-6 max-w-md text-sm leading-7 text-white/70">
              Cosméticos botânicos, cerâmica autoral e devoção cotidiana reunidos
              em uma vitrine contemplativa, fiel às telas do Stitch e pronta para
              consumir a API do ateliê.
            </p>
          </div>
          <div>
            ...
            <div className="mt-4 space-y-3 text-sm text-white/70">
              <Link className="block hover:text-white" href="/beleza-natural">
                Beleza Natural
              </Link>
              <Link className="block hover:text-white" href="/artesanato">
                Artesanato
              </Link>
              <Link className="block hover:text-white" href="/carrinho">
                Meu Carrinho
              </Link>
            </div>
          </div>
